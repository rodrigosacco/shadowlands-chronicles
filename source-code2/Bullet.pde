class Bullet {
  ...
  Bullet(int startingX, int startingY, int directionX, int directionY){
    ...
    imgRight = loadImage("./Mage/Magic/Magic_R.png");
    imgLeft = loadImage("./Mage/Magic/Magic_L.png");
    imgUp = loadImage("./Mage/Magic/Magic_U.png");
    imgDown = loadImage("./Mage/Magic/Magic_D.png");
  }
